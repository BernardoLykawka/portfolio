...
export const siteConfig = {
  ...
  AboutMe: "As a Software Engineering student and Full-Stack Developer, I bridge the gap between complex backend logic and intuitive user experiences. I thrive in collaborative environments—from hackathons to academic labs—turning ideas into reality through strong engineering practices. \n\nMy workflow is built on collaboration, continuous learning, and modern tools. I am currently seeking an opportunity to bring my proactive attitude and technical skills to a dynamic team where I can grow and make a tangible impact.",
